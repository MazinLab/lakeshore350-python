...
def execute_step4(gl7_controller):
    ...
    pre_4k_stage = gl7_controller.read_temperature('D3')   # 4K stage (Input D3)
    pre_50k_stage = gl7_controller.read_temperature(2)  # 50K stage (Channel 2)
    print(f"  4K Stage Temperature (D3): {pre_4k_stage} K")
    print(f"  50K Stage Temperature (Channel 2): {pre_50k_stage} K")

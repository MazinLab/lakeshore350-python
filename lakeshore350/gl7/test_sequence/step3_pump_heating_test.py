...
def execute_step3_test(gl7_controller):
    ...
    # Get user input for 4-pump heater percentage (TEST MODE - commands will not execute)
    while True:
        try:
    ...
    # Get user input for 3-pump heater percentage (TEST MODE - commands will not execute)
    while True:
        try:
    ...
    print(f"\nStep 3 Summary:")
    print(f"  4-pump Heater set to: {power_4pump}% power (TEST MODE - heater remains unchanged)")
    print(f"  3-pump Heater set to: {power_3pump}% power (TEST MODE - heater remains unchanged)")
